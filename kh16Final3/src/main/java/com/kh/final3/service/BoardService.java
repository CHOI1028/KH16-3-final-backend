...
//    private MemberDao memberDao; 
     ...
     */
	@Transactional
	public BoardDto insert(BoardDto boardDto, String loginLevel) {
    ...
    /**
     * 2. 게시글 목록 조회
     * - 순수 BOARD 목록을 조회한 후, 각 게시글의 작성자 닉네임 정보를 조합합니다. (JOIN 회피)
     */
    public List<BoardDto> selectList() {
	    // 1. DAO를 통해 BOARD 데이터 목록만 조회
	    List<BoardDto> list = boardDao.selectList(); 
	    
//	    // 2. 목록을 순회하며 작성자 정보 조합 (Service의 역할)
//	    for (BoardDto boardDto : list) {
//            // memberDao.findNicknameByMemberNo() 메서드는 MemberDao에 구현이 필요
...
//	    }
        ...
        // TODO: QNA 게시판의 경우, 관리자가 아니면 목록에서 조회되지 않도록 필터링 로직 추가
...
//	    }
     ...
     */
    @Transactional
    public void update(BoardDto boardDto, String loginId, String loginLevel) {
        ...
        // b. 작성자는 본인 글만 수정 가능 (loginId와 DB에 저장된 작성자 ID를 비교)
        else if (originDto.getBoardWriter().equals(loginId)) {
            // 통과
        } 
        // c. 권한 없는 사용자
        else {
     ...
     */
    @Transactional
	public void delete(long boardNo, String loginId, String loginLevel) {
