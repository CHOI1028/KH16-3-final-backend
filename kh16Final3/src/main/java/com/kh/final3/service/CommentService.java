...
public class CommentService {
    ...
    // 댓글 목록에 작성자 닉네임을 조합하기 위해 MemberDao 주입
//    @Autowired
//    private MemberDao memberDao; 
     ...
     */
//    @Transactional
//    public CommentDto insert(CommentDto commentDto, String loginId) {
...
//        // 닉네임 조합
//        String writerNickname = memberDao.findNicknameByMemberNo(loginId);
...
//            commentDto.setWriterNickname(writerNickname);
//
//            // TODO: softDelete된 댓글('n')의 경우, 내용('commentContent')을 "삭제된 댓글입니다."로 치환하는 로직 추가
//        }
//        
//        return list;
//    }
     ...
     */
    @Transactional
    public void update(CommentDto commentDto, String loginId, String loginLevel) {
        ...
        // b. 작성자 본인 확인
        else if (originDto.getCommentWriter().equals(loginId)) {
            // 통과
        }
        // c. 권한 없음
        else {
     ...
     */
    @Transactional
    public void softDelete(long commentNo, String loginId, String loginLevel) {
